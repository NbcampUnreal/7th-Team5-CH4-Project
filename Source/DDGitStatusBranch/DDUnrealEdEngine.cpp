#include "DDUnrealEdEngine.h"

#include "ISourceControlModule.h"

void UDDUnrealEdEngine::Init(IEngineLoop* InEngineLoop)
{
	...
	const TArray<FString> Branches {"origin/main", "origin/release", "origin/develop", "origin/feature/*", "origin/hotfix/*"};
