...
void FLogManager::SetEnabled(ELogOwner Owner, bool bEnable)
{
...
void FLogManager::ToggleAll(bool bEnable)
{
...
bool FLogManager::IsEnabled(ELogOwner Owner) const
{
...
void FLogManager::SetEnabledByName(const FString& OwnerName, bool bEnable)
{
...
void FLogManager::DumpStatus() const
{
